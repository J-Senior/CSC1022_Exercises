...
public class Rational implements Comparable<Rational>{
    ...
    public Rational add(Rational rhs) throws Error {
        return new Rational(num * rhs.denom + rhs.num * denom, denom * rhs.denom).num == 0 ? new Rational(num * rhs.denom + rhs.num * denom, denom * rhs.denom) : new Rational(num * rhs.denom + rhs.num * denom, denom * rhs.denom).simplify();
    }
    ...
    public Rational multiply(Rational rhs) throws Error {
    	return new Rational(num * rhs.num, denom * rhs.denom).num == 0 ?  new Rational(num * rhs.num, denom * rhs.denom) : new Rational(num * rhs.num, denom * rhs.denom).simplify();
    }
